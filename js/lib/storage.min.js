...
(function () {
    ...
    var ga = q[q.length - 1],
        ...
        w = function () {
            ...
            c.prototype.ia = function (a) {
                if (a === this) this.K(new TypeError("A Promise cannot resolve to itself"));
                else if (a instanceof c) this.la(a);
                else {
                    var b;
                    a: switch (typeof a) {
                        case "object":
    ...
    "undefined" !== typeof C.V && C.V || (C.ta = __extends, C.sa = __decorate, C.ua = __metadata, C.va = __param, C.ra = __awaiter);
    var D = function (a) {
    ...
    Q.prototype.aa = function () {
        for (var a; a = Ha(this);) {
            ...
            if (a.child) a.child.B = null, Ia(a, b, c);
            else try {
        ...
        return new Q(function (b, c) {
            ...
            if (d)
                for (var f = function (a, c) {
                        ...
                        c(a)
                    }, k = 0, l; k < a.length; k++) l = a[k], Aa(l, ka(f, k), g);
            else b(e)
        })
    };
    ...
    var U = function (a, b) {
            if (!a.u)
                for (var c = 0; c < a.b.length; c++) Oa(a, c, b)
        },
        Oa = function (a, b, c) {
    ...
    function Ma(a) {
        ...
        for (var b = n(["next", "error", "complete"]), c = b.next(); !c.done; c = b.next())
            if (c = c.value, c in a && "function" === typeof a[c]) return !0;
        return !1
    }

    function Na() {};
    var Pa = Error.captureStackTrace,
        V = function (a, b) {
            this.code = a;
            this.message = b;
            if (Pa) Pa(this, Qa.prototype.create);
            else {
...
(function () {
    ...
    Ab.prototype.preventDefault = function () {
        Ab.Vc.preventDefault.call(this);
        var a = this.ob;
    ...
    Fb.prototype.add = function (a, b, c, d, e) {
        ...
        var g = Gb(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Fb = !1)) : (b = new Db(b, this.src, f, !!d, e), b.Fb = c, a.push(b));
        return b
    };
    ...
    var Hb = function (a, b) {
        var c = b.type;
        c in a.A && La(a.A[c], b) && (Eb(b), 0 == a.A[c].length && (delete a.A[c], a.Cb--))
    };
    Fb.prototype.Ac = function (a, b, c, d) {
        a = this.A[a.toString()];
        var e = -1;
        a && (e = Gb(a, b, c, d));
        return -1 < e ? a[e] : null
    ...
    var Ib = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Ub = function (a, b, c, d, e) {
            ...
            else c = Mb(c), a && a[Bb] ? a.ba.remove(String(b), c, d, e) : a && (a = Ob(a)) && (b = a.Ac(b, c, !!d, e)) && Vb(b)
        },
        Vb = function (a) {
            if (!ga(a) && a && !a.cb) {
                var b = a.src;
                if (b &&
                    ...
                    var c = a.type,
                        d = a.ac;
                    b.removeEventListener ? b.removeEventListener(c, d, a.Gb) : b.detachEvent && b.detachEvent(Qb(c), d);
                    Kb--;
                    (c = Ob(b)) ? (Hb(c, a), 0 == c.Cb && (c.src = null, b[Ib] = null)) : Eb(a)
                }
            }
        },
        Qb = function (a) {
            ...
            if (a = Ob(a))
                if (b = a.A[b.toString()])
                    for (b = b.concat(), a = 0; a < b.length; a++) {
                        var f = b[a];
                        f && f.Gb == c && !f.cb && (f = Wb(f, d), e = e && !1 !== f)
                    }
            return e
        },
        Wb = function (a, b) {
    ...
    var bc = function (a) {
            if (a instanceof ac && a.constructor === ac && a.Td === $b) return a.kc;
    ...
    var ec = function (a) {
            if (a instanceof B && a.constructor === B && a.Sd === dc) return a.la;
    ...
    var ic = function (a) {
            ...
            if (null == b) c.push("null");
                ...
                if ("object" == typeof b) {
                    if (ea(b)) {
                        ...
                        b = d.length;
                        c.push("[");
                        for (var e = "", f = 0; f < b; f++) c.push(e), e = d[f], kc(a, a.ec ? a.ec.call(d, String(f), e) : e, c), e = ",";
                        c.push("]");
                        return
                    }
                    if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                        ...
                        c.push("{");
                        f = "";
                        for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (e = b[d], "function" != typeof e && (c.push(f), nc(d, c), c.push(":"), kc(a, a.ec ? a.ec.call(b, d, e) : e, c), f = ","));
                        c.push("}");
                        return
                    }
                }
        ...
        pc = /\uffff/.test("\uffff") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g,
        nc = function (a, b) {
    ...
    vc.prototype.nb = function () {
        ...
        if ("undefined" != typeof XDomainRequest) return new wc;
    ...
    h.send = function (a) {
        if (a)
            if ("string" == typeof a) this.qa.send(a);
    ...
    var C = function (a, b) {
        ...
        zc = function (a) {
            ...
            b = new C([a | 0], 0 > a ? -1 : 0); - 128 <= a && 128 > a && (yc[a] = b);
            return b
        },
        F = function (a) {
        ...
        Ac = function (a, b) {
            ...
            if (2 > b || 36 < b) throw Error("radix out of range: " +
                b);
            if ("-" == a.charAt(0)) return E(Ac(a.substring(1), b));
        ...
        Cc = zc(16777216),
        Dc = function (a) {
            if (-1 == a.g) return -Dc(E(a));
            for (var b = 0, c = 1, d = 0; d < a.h.length; d++) b += Ec(a, d) * c, c *= 4294967296;
            return b
        };
    ...
    C.prototype.compare = function (a) {
        a = Hc(this, a);
        return -1 == a.g ? -1 : Fc(a) ? 0 : 1
    };
    var E = function (a) {
        for (var b = a.h.length, c = [], d = 0; d < b; d++) c[d] = ~a.h[d];
        return (new C(c, ~a.g)).add(Bc)
    };
    ...
    var Ic = function (a, b) {
        ...
        Gc = function (a, b) {
            if (Fc(b)) throw Error("division by zero");
            if (Fc(a)) return D;
            if (-1 == a.g) return -1 == b.g ? Gc(E(a), E(b)) : E(Gc(E(a), b));
            if (-1 == b.g) return E(Gc(a, E(b)));
            if (30 < a.h.length) {
                if (-1 == a.g || -1 == b.g) throw Error("slowDivide_ only works with positive integers.");
                for (var c = Bc; 0 >= b.compare(a);) c = c.shiftLeft(1), b = b.shiftLeft(1);
                var d = Jc(c, 1),
                    e = Jc(b, 1),
                    f;
                b = Jc(b, 2);
                for (c = Jc(c, 2); !Fc(b);) f = e.add(b), 0 >= f.compare(a) && (d = d.add(c),
                    e = f), b = Jc(b, 1), c = Jc(c, 1);
                return d
            }
            for (c = D; 0 <= a.compare(b);) {
                d = Math.max(1, Math.floor(Dc(a) / Dc(b)));
    ...
    var Jc = function (a, b) {
        var c = b >> 5;
        b %= 32;
        for (var d = a.h.length - c, e = [], f = 0; f < d; f++) e[f] = 0 < b ? G(a, f + c) >>> b | G(a, f + c + 1) << 32 - b : G(a, f + c);
        return new C(e, a.g)
    };
    var Lc = function (a, b) {
        this.sb = a;
    ...
    Lc.prototype.Ib = function (a) {
        return this.pa == a.pa && this.sb.Ib(Wa(a.sb))
    };
    Lc.prototype.toString = ca;
    var Oc = function (a) {
            try {
                var b;
                ...
                return b ? new Mc(a.substring(1, a.length - 1)) : new Nc(a)
            } catch (d) {
                return null
            }
        },
        Nc = function (a) {
            var b = D;
            if (a instanceof C) {
                if (0 != a.g || 0 > a.compare(D) || 0 < a.compare(Pc)) throw Error("The address does not look like an IPv4.");
                b = Wa(a)
            } else {
                if (!Qc.test(a)) throw Error(a + " does not look like an IPv4 address.");
                var c = a.split(".");
    ...
    r(Nc, Lc);
    var Qc = /^[0-9.]*$/,
        Pc = Hc(Bc.shiftLeft(32), Bc);
    Nc.prototype.toString = function () {
        if (this.Ea) return this.Ea;
        for (var a = Ec(this.sb, 0), b = [], c = 3; 0 <= c; c--) b[c] = String(a & 255), a >>>= 8;
        return this.Ea = b.join(".")
    };
    var Mc = function (a) {
        var b = D;
        if (a instanceof C) {
            if (0 != a.g || 0 > a.compare(D) || 0 < a.compare(Rc)) throw Error("The address does not look like a valid IPv6.");
            b = Wa(a)
        } else {
            if (!Sc.test(a)) throw Error(a + " is not a valid IPv6 address.");
            var c = a.split(":");
            if (-1 != c[c.length - 1].indexOf(".")) {
                a = Ec(Wa((new Nc(c[c.length - 1])).sb), 0);
                var d = [];
            ...
            for (d = 0; d < c.length; d++) {
                e = Ac(c[d], 16);
                if (0 > e.compare(D) || 0 < e.compare(Tc)) throw Error(c[d] + " in " + a + " is not a valid hextet.");
                b = Kc(b.shiftLeft(16), e)
            }
        }
        Lc.call(this, b, 6)
    };
    r(Mc, Lc);
    var Sc = /^([a-fA-F0-9]*:){2}[a-fA-F0-9:.]*$/,
        Tc = zc(65535),
        Rc = Hc(Bc.shiftLeft(128), Bc);
    ...
    var Yc = function (a) {
            if (a instanceof Xc && a.constructor === Xc && a.Rd === Wc) return a.la;
            za("expected object of type SafeHtml, got '" + a + "' of type " + m(a));
            return "type_error:SafeHtml"
        },
        Wc = {};
    Xc.prototype.ye = function (a) {
        this.la = a;
        return this
    };
    ...
    ad.prototype.put = function (a) {
        this.Le(a);
        this.Vb < this.Ae && (this.Vb++, a.next = this.Ob, this.Ob = a)
    };
    var bd = function (a) {
    ...
    var ld = function (a, b) {
        ...
        hd, id = function () {
            ...
            if (-1 != String(a).indexOf("[native code]")) {
                ...
                var a = md;
                !p(l.setImmediate) || l.Window && l.Window.prototype && !y("Edge") && l.Window.prototype.setImmediate == l.setImmediate ? (cd || (cd = dd()), cd(a)) : l.setImmediate(a)
            }
        },
        jd = !1,
        kd = new ed,
            ...
            return new H(function (b) {
                ...
                if (c)
                    for (var e = function (a, e, f) {
                            ...
                            0 == c && b(d)
                        }, f = 0, g; f < a.length; f++) g = a[f], vd(g, ka(e, f, !0),
                        ka(e, f, !1));
                else b(d)
            })
        };
    H.prototype.then = function (a, b, c) {
        ...
        return xd(this, p(a) ? a : null, p(b) ? b : null, c)
    };
    nd(H);
    var zd = function (a, b) {
        b = td(b, b, void 0);
            ...
            if (0 == a.J)
                if (a.s) {
                    ...
                    if (c.ha) {
                        ...
                        e && (0 == c.J && 1 == d ? Ad(c, b) : (f ? (d = f, w(c.ha), w(null != d), d.next == c.Pa && (c.Pa = d), d.next = d.next.next) : Bd(c), Cd(c, e, 3, b)))
                    }
                    a.s = null
                } else pd(a, 3, b)
        },
        yd = function (a, b) {
            a.ha || 2 != a.J && 3 != a.J || Dd(a);
            w(null != b.Ga);
        ...
        xd = function (a, b, c, d) {
            ...
            e.child = new H(function (a, g) {
                ...
                e.Va = c ? function (b) {
                    try {
                        var e = c.call(d, b);
                        void 0 === e && b instanceof qd ? g(b) : a(e)
                    } catch (ua) {
                        g(ua)
                    }
                } : g
    ...
    var pd = function (a, b, c) {
            0 == a.J && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.J = 1, ud(c, a.Ue, a.Ve, a) || (a.ma = c, a.J = b, a.s = null, Dd(a), 3 != b || c instanceof qd || Ed(a, c)))
        },
        ud = function (a, b, c, d) {
            if (a instanceof H) return null != b && Ca(b, "opt_onFulfilled should be a function."), null != c && Ca(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"), yd(a, td(b || ba, c || null, d)), !0;
    ...
    H.prototype.fe = function () {
        for (var a; a = Bd(this);) Cd(this, a, this.J, this.ma);
        this.yc = !1
    };
    var Cd = function (a, b, c, d) {
            if (3 == c && b.Va && !b.lb)
                for (; a && a.Mb; a = a.s) a.Mb = !1;
            if (b.child) b.child.s = null, Gd(b, c, d);
            else try {
                b.lb ? b.Ga.call(b.context) : Gd(b, c, d)
            } catch (e) {
                Hd.call(null, e)
            }
            sd.put(b)
    ...
    */
    ...
    Id.prototype.cancel = function (a) {
        if (this.Ta) this.ma instanceof Id && this.ma.cancel();
        else {
            if (this.s) {
                var b = this.s;
                delete this.s;
            ...
            this.Ta || Jd(this, new Kd)
        }
    };
    Id.prototype.dd = function (a, b) {
        this.tc = !1;
        Ld(this, a, b)
    };
    var Ld = function (a, b, c) {
        ...
        Od = function (a) {
            if (a.Ta) {
                if (!a.Tc) throw new Nd;
                a.Tc = !1
            }
        };
    Id.prototype.callback = function (a) {
        Od(this);
        Pd(a);
        Ld(this, !0, a)
    };
    var Jd = function (a, b) {
        ...
        Pd = function (a) {
            w(!(a instanceof Id), "An execution sequence may not be initiated with a blocking Deferred.")
        },
        Td = function (a) {
    ...
    var Ud = function (a) {
        ...
        Md = function (a) {
            if (a.nc && a.Ta && Ud(a)) {
                var b = a.nc,
                    c = Vd[b];
                c && (l.clearTimeout(c.rb), delete Vd[b]);
                a.nc = 0
            }
            ...
            for (var b = a.ma, d = c = !1; a.gc.length && !a.tc;) {
                ...
                if (f = a.qb ? g : f) try {
                    ...
                    if (od(b) || "function" === typeof l.Promise && b instanceof l.Promise) d = !0, a.tc = !0
                } catch (t) {
                    b = t, a.qb = !0, Ud(a) || (c = !0)
                }
            }
            a.ma = b;
            d &&
                (k = q(a.dd, a, !0), d = q(a.dd, a, !1), b instanceof Id ? (Sd(b, k, d), b.Yc = !0) : b.then(k, d));
            c && (b = new Wd(b), Vd[b.rb] = b, a.nc = b.rb)
        },
        Nd = function () {
            u.call(this)
        };
    ...
    var Wd = function (a) {
        this.rb = l.setTimeout(q(this.Te, this), 0);
        this.N = a
    };
    Wd.prototype.Te = function () {
        w(Vd[this.rb], "Cannot throw an error that is not scheduled.");
        delete Vd[this.rb];
        throw this.N;
    };
    var Vd = {};
    var Qd = function (a) {
        ...
        Xd = function (a) {
            var b = {},
                ...
                d;
            a instanceof Vc && a.constructor === Vc && a.Ud === Uc ? d = a.Zb : (za("expected object of type TrustedResourceUrl, got '" + a + "' of type " + m(a)), d = "type_error:TrustedResourceUrl");
            ...
            0 < k && (g = window.setTimeout(function () {
                Zd(e, !0);
                Jd(f, new $d(1, "Timeout reached for loading script " + d))
            }, k), a.Bb = g);
            e.onload =
                e.onreadystatechange = function () {
                    e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Zd(e, b.ef || !1, g), f.callback(null))
                };
            e.onerror = function () {
                Zd(e, !0, g);
                Jd(f, new $d(0, "Error while loading script " + d))
            };
            a = b.attributes || {};
            Ya(a, {
    ...
    h.dispatchEvent = function (a) {
        ...
        var e = !0,
            f;
        if (b)
            for (var g = b.length - 1; !a.Ya && 0 <= g; g--) f = a.currentTarget = b[g], e = de(f, d, !0, a) && e;
        a.Ya || (f = a.currentTarget = c, e = de(f, d, !0, a) && e, a.Ya || (e = de(f, d, !1, a) && e));
        if (b)
            for (g = 0; !a.Ya && g < b.length; g++) f = a.currentTarget = b[g], e = de(f, d, !1, a) && e;
        return e
    };
    h.Ra = function () {
        be.Vc.Ra.call(this);
    ...
    be.prototype.Ac = function (a, b, c, d) {
    ...
    var ee = "StopIteration" in l ? l.StopIteration : {
    ...
    ge.prototype.remove = function (a) {
        return ie(this.ca, a) ? (delete this.ca[a], this.i--, this.pa++, this.v.length > 2 * this.i && he(this), !0) : !1
    };
    var he = function (a) {
        if (a.i != a.v.length) {
        ...
        if (a.i != a.v.length) {
            for (var e = {}, c = b = 0; b < a.v.length;) d = a.v[b], ie(e, d) || (a.v[c++] = d, e[d] = 1), b++;
            a.v.length = c
        }
    };
    h = ge.prototype;
    h.get = function (a, b) {
        return ie(this.ca, a) ? this.ca[a] : b
    };
    h.set = function (a, b) {
        ie(this.ca, a) || (this.i++, this.v.push(a), this.pa++);
        this.ca[a] = b
    };
    h.addAll = function (a) {
        var b;
        a instanceof ge ? (b = a.ja(), a = a.X()) : (b = Ta(a), a = Sa(a));
    ...
    var ke = function (a) {
        ...
        me = function (a, b) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);
                ...
                for (var c = le(a), d = ke(a), e =
                        d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f], a)
        };
    var ne = function (a, b, c, d, e) {
        this.reset(a, b, c, d, e)
    };
    ne.prototype.hd = null;
    var oe = 0;
    ne.prototype.reset = function (a, b, c, d, e) {
        "number" == typeof e || oe++;
        d || la();
        this.ub = a;
        this.Ee = b;
    ...
    var re = new qe("SEVERE", 1E3),
        ...
        te = new qe("FINE", 500);
    pe.prototype.getParent = function () {
        return this.s
    };
    ...
    var ue = function (a) {
        if (a.ub) return a.ub;
        if (a.s) return ue(a.s);
        za("Root logger has no level set.");
        return null
    };
    pe.prototype.log = function (a, b, c) {
        if (a.value >= ue(this).value)
            for (p(b) && (b = b()), a = new ne(a, String(b), this.Fe), c && (a.hd = c), c = "log:" + a.Ee, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this; c;) {
                b = c;
                var d = a;
                if (b.nd)
                    for (var e = 0, f; f = b.nd[e]; e++) f(d);
                c = c.getParent()
            }
    };
    var ve = {},
    ...
    var L = function (a) {
        ...
        this.mc = null;
        this.Ad = "";
        this.oc = this.Ke = this.Nd = !1
    };
    r(L, be);
    var Ce = L.prototype,
        De = xe("goog.net.XhrIo");
    Ce.T = De;
    var Ee = /^https?$/i,
        Fe = ["POST", "PUT"];
    L.prototype.send = function (a, b, c, d) {
        ...
        this.xc = !1;
        this.ra = !0;
        this.b = this.rc ? this.rc.nb() : sc.nb();
        this.qc = this.rc ? rc(this.rc) : rc(sc);
        this.b.onreadystatechange = q(this.xd, this);
        this.Ke && "onprogress" in this.b && (this.b.onprogress = q(function (a) {
            this.wd(a, !0)
        }, this), this.b.upload && (this.b.upload.onprogress = q(this.wd, this)));
        try {
            K(this.T, Ge(this, "Opening Xhr")),
                this.Dc = !0, this.b.open(b, String(a), !0), this.Dc = !1
        } catch (f) {
            K(this.T, Ge(this, "Error opening Xhr: " + f.message));
            this.N(5, f);
            return
        }
        a = c || "";
        ...
        !Ja(Fe, b) || d || c || e.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
        ...
        "withCredentials" in this.b && this.b.withCredentials !== this.Nd && (this.b.withCredentials =
            this.Nd);
        try {
            He(this), 0 < this.ib && (this.oc = Ie(this.b), K(this.T, Ge(this, "Will abort after " + this.ib + "ms if incomplete, xhr2 " + this.oc)), this.oc ? (this.b.timeout = this.ib, this.b.ontimeout = q(this.Bb, this)) : this.mc = ye(this.Bb, this.ib, this)), K(this.T, Ge(this, "Sending request")), this.Rb = !0, this.b.send(a), this.Rb = !1
        } catch (f) {
            K(this.T, Ge(this, "Send error: " + f.message)), this.N(5, f)
        }
    };
    var Ie = function (a) {
    ...
    L.prototype.Bb = function () {
        "undefined" != typeof aa && this.b && (this.tb = "Timed out after " + this.ib + "ms, aborting", K(this.T, Ge(this, this.tb)), this.dispatchEvent("timeout"), this.abort(8))
    };
    ...
    L.prototype.abort = function () {
        this.b && this.ra && (K(this.T, Ge(this, "Aborting")), this.ra = !1, this.Da = !0, this.b.abort(), this.Da = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Ke(this))
    };
    L.prototype.Ra = function () {
        this.b && (this.ra && (this.ra = !1, this.Da = !0, this.b.abort(), this.Da = !1), Ke(this, !0));
        L.Vc.Ra.call(this)
    };
    L.prototype.xd = function () {
        this.isDisposed() || (this.Dc || this.Rb || this.Da ? Le(this) : this.Ie())
    };
    ...
    var Le = function (a) {
        if (a.ra && "undefined" != typeof aa)
            if (a.qc[1] && 4 == Me(a) && 2 == Ne(a)) K(a.T, Ge(a, "Local request error detected and ignored"));
            else if (a.Rb && 4 == Me(a)) ye(a.xd, 0, a);
        else if (a.dispatchEvent("readystatechange"), 4 == Me(a)) {
            K(a.T, Ge(a, "Request complete"));
            a.ra = !1;
            try {
                var b = Ne(a),
                    c;
                ...
                if (d) a.dispatchEvent("complete"), a.dispatchEvent("success");
                    ...
                    var k;
                    try {
                        k = 2 < Me(a) ? a.b.statusText : ""
                    } catch (t) {
                        K(a.T, "Can not get status: " + t.message), k = ""
                    }
                    a.tb = k + " [" + Ne(a) + "]";
                    Je(a)
                }
    ...
    var Oe = function (a, b) {
        ...
        Ke = function (a, b) {
            if (a.b) {
                ...
                try {
                    ...
                    (a = a.T) && a.log(re, "Problem encountered resetting onreadystatechange: " + e.message, void 0)
                }
            }
        },
        He = function (a) {
        ...
        Pe = function (a) {
            try {
                ...
                return K(a.T, "Can not get responseText: " + b.message), ""
            }
        },
        Ge = function (a, b) {
            return b + " [" + a.sd + " " + a.Ub + " " + Ne(a) + "]"
        };
    var Qe = function (a, b) {
        ...
        this.P = this.ze = !1;
        var c;
        a instanceof Qe ? (this.P = void 0 !== b ? b : a.P, Re(this, a.na), c = a.Ka, M(this), this.Ka = c, Se(this, a.ia), Te(this, a.Xa), Ue(this, a.ta), Ve(this, a.$.clone()), a = a.Ca, M(this), this.Ca = a) : a && (c = String(a).match(Ae)) ? (this.P = !!b, Re(this, c[1] || "", !0), a = c[2] || "", M(this), this.Ka = We(a), Se(this, c[3] || "", !0), Te(this, c[4]), Ue(this, c[5] || "", !0), Ve(this, c[6] || "", !0), a = c[7] || "", M(this), this.Ca = We(a)) : (this.P = !!b, this.$ = new N(null,
            0, this.P))
    };
    Qe.prototype.toString = function () {
        var a = [],
        ...
        b && a.push(Xe(b, Ye, !0), ":");
        var c = this.ia;
        if (c || "file" == b) a.push("//"), (b = this.Ka) && a.push(Xe(b, Ye, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.Xa, null != c && a.push(":", String(c));
        if (c = this.ta) this.ia && "/" != c.charAt(0) && a.push("/"), a.push(Xe(c, "/" == c.charAt(0) ? Ze : $e, !0));
        (c = this.$.toString()) && a.push("?", c);
        (c = this.Ca) && a.push("#", Xe(c, af));
        return a.join("")
    };
    Qe.prototype.resolve = function (a) {
        ...
        c ? Se(b, a.ia) : c = null != a.Xa;
        d = a.ta;
        if (c) Te(b, a.Xa);
        else if (c = !!a.ta) {
            if ("/" != d.charAt(0))
                if (this.ia && !this.ta) d = "/" + d;
                else {
        ...
        c ? Ue(b, d) : c = "" !== a.$.toString();
        c ? Ve(b, We(a.$.toString())) : c = !!a.Ca;
        c && (a = a.Ca, M(b), b.Ca = a);
        return b
    };
    ...
    var Re = function (a, b, c) {
        ...
        Ve = function (a, b, c) {
            M(a);
            b instanceof N ? (a.$ = b, a.$.Sc(a.P)) : (c || (b = Xe(b, bf)), a.$ = new N(b, 0, a.P))
        },
        O = function (a, b, c) {
            M(a);
            a.$.set(b, c)
        ...
        M = function (a) {
            if (a.ze) throw Error("Tried to modify a read-only Uri");
        };
    Qe.prototype.Sc = function (a) {
        this.P = a;
        this.$ && this.$.Sc(a);
        return this
    };
    var df = function (a) {
            return a instanceof Qe ? a.clone() : new Qe(a, void 0)
        },
        ef = function (a, b) {
            var c = new Qe(null, void 0);
            Re(c, "https");
            a && Se(c, a);
            b && Ue(c, b);
            return c
        ...
        Xe = function (a, b, c) {
            return n(a) ? (a = encodeURI(a).replace(b, ff), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
        },
        ff = function (a) {
            a = a.charCodeAt(0);
        ...
        gf = function (a) {
            a.j || (a.j = new ge, a.i = 0, a.M && Be(a.M, function (b, c) {
    ...
    h.ja = function () {
        gf(this);
        for (var a = this.j.X(), b = this.j.ja(), c = [], d = 0; d < b.length; d++)
    ...
    h.X = function (a) {
        gf(this);
        var b = [];
        if (n(a)) this.mb(a) && (b = Na(b, this.j.get(this.O(a))));
        else {
            a = this.j.X();
    ...
    var hf = function (a, b, c) {
        a.remove(b);
        0 < c.length && (a.M = null, a.j.set(a.O(b), Pa(c)), a.i = Aa(a.i) + c.length)
    };
    N.prototype.toString = function () {
        if (this.M) return this.M;
        if (!this.j) return "";
        for (var a = [], b = this.j.ja(), c = 0; c < b.length; c++)
    ...
    N.prototype.Sc = function (a) {
        a && !this.P && (gf(this), this.M = null, this.j.forEach(function (a, c) {
            var b = c.toLowerCase();
            c != b && (this.remove(c), hf(this, b, a))
        }, this));
        this.P = a
    };
    var lf = function () {
        ...
        nf = function (a, b) {
            var c = [],
                d;
            for (d in a) d in b ? typeof a[d] != typeof b[d] ? c.push(d) : ea(a[d]) ? Va(a[d], b[d]) || c.push(d) : "object" == typeof a[d] && null != a[d] && null != b[d] ? 0 < nf(a[d], b[d]).length && c.push(d) : a[d] !== b[d] && c.push(d) : c.push(d);
        ...
        pf = function () {
            var a;
            a = kf();
            a = "Chrome" != of (a) ? null : (a = a.match(/\sChrome\/(\d+)/i)) && 2 == a.length ? parseInt(a[1],
                10) : null;
        ...
        rf = function (a, b, c) {
            ...
            d && (b.target = d);
            "Firefox" == of (kf()) && (a = a || "http://localhost", b.scrollbars = !0);
            var g;
            c = a || "about:blank";
            (d = b) || (d = {});
            a = window;
            b = c instanceof B ? c : hc("undefined" !=
                typeof c.href ? c.href : String(c));
            c = d.target || c.target;
            e = [];
            for (g in d) switch (g) {
                case "width":
            ...
            (y("iPhone") && !y("iPod") && !y("iPad") || y("iPad") || y("iPod")) && a.navigator && a.navigator.standalone && c && "_self" != c ? (g = a.document.createElement("A"), "undefined" != typeof HTMLAnchorElement && "undefined" != typeof Location && "undefined" != typeof Element && (e = g && (g instanceof HTMLAnchorElement || !(g instanceof Location || g instanceof Element)), f = ha(g) ? g.constructor.displayName || g.constructor.name || Object.prototype.toString.call(g) : void 0 === g ? "undefined" : null === g ? "null" : typeof g, w(e, "Argument is not a HTMLAnchorElement (or a non-Element mock); got: %s", f)), b = b instanceof B ? b : hc(b), g.href = ec(b), g.setAttribute("target", c), d.noreferrer && g.setAttribute("rel", "noreferrer"), d = document.createEvent("MouseEvent"), d.initMouseEvent("click", !0, !0, a, 1), g.dispatchEvent(d), g = {}) : d.noreferrer ?
                (g = a.open("", c, g), d = ec(b), g && (gb && v(d, ";") && (d = "'" + d.replace(/'/g, "%27") + "'"), g.opener = null, a = cc("b/12014412, meta tag with sanitized URL"), va.test(d) && (-1 != d.indexOf("&") && (d = d.replace(oa, "&amp;")), -1 != d.indexOf("<") && (d = d.replace(pa, "&lt;")), -1 != d.indexOf(">") && (d = d.replace(qa, "&gt;")), -1 != d.indexOf('"') && (d = d.replace(ra, "&quot;")), -1 != d.indexOf("'") && (d = d.replace(sa, "&#39;")), -1 != d.indexOf("\x00") && (d = d.replace(ta, "&#0;"))), d = '<META HTTP-EQUIV="refresh" content="0; url=' + d + '">', Ba(bc(a), "must provide justification"),
                    w(!/^[\s\xa0]*$/.test(bc(a)), "must provide non-empty justification"), g.document.write(Yc((new Xc).ye(d))), g.document.close())) : g = a.open(ec(b), c, g);
            if (g) try {
                g.focus()
            } catch (k) {}
            return g
        ...
        wf = function (a) {
            var b = uf(void 0);
            return ("Browser" === b ? of (kf()) : b) + "/JsCore/" + a
        },
        kf = function () {
        ...
        zf = function () {
            var a;
            if (!(a = !l.location || !l.location.protocol || "http:" != l.location.protocol && "https:" != l.location.protocol || vf())) {
                var b;
                a: {
                    try {
        ...
        Af = function (a) {
            a = a || kf();
            var b = (a || kf()).toLowerCase();
            return b.match(/android/) || b.match(/webos/) || b.match(/iphone|ipad|ipod/) || b.match(/blackberry/) ||
                b.match(/windows phone/) || b.match(/iemobile/) || "Firefox" == of (a) ? !1 : !0
        },
        Bf = function (a) {
            return "undefined" === typeof a ? null : mc(a)
        },
        Cf = function (a) {
            var b = {},
                c;
        ...
        Ef = function (a) {
            a = a || kf();
            return "Safari" == of (a) || a.toLowerCase().match(/iphone|ipad|ipod/) ?
                !1 : !0
        },
        Ff = function () {
            var a = l.___jsl;
    ...
    Tf.prototype.Kb = function (a) {
        return Uf(a, Vf(this))
    };
    Tf.prototype.td = function (a, b) {
        var c = Vf(this);
        c.idToken = b;
        return Wf(a, c)
    };
    var Vf = function (a) {
        ...
        return {
            postBody: jf(b).toString(),
            requestUri: zf() ? mf() : "http://localhost"
        }
    };
    ...
    var $f = Xf("google.com", !1, Of("google.com"));
    $f.prototype.addScope = $f.prototype.addScope || void 0;
    $f.credential = function (a, b) {
    ...
    var ag = Xf("twitter.com", !0, Of("twitter.com")),
        bg = function (a, b) {
            this.Hb = a;
            this.Jc = b;
            P(this, "provider", "password")
        };
    bg.prototype.Kb = function (a) {
        return R(a, cg, {
            email: this.Hb,
            password: this.Jc
        })
    };
    bg.prototype.td = function (a, b) {
        return R(a, dg, {
            idToken: b,
            email: this.Hb,
            password: this.Jc
    ...
    var fg = {
        ...
        gg = function (a) {
            ...
            a = a && a.oauthIdToken;
            for (var e in fg)
                if (fg[e].PROVIDER_ID == b) try {
                    return fg[e].credential({
                        accessToken: c,
                        idToken: a,
                        oauthToken: c,
                        oauthTokenSecret: d
    ...
    hg.prototype.K = function () {
        var a = {
            ...
            b = this.credential && this.credential.K();
    ...
    var ig = function (a) {
        if (a.code) {
            ...
            return a.email ? new hg(b, a.email, gg(a), a.message) : new Q(b, a.message || void 0)
        }
        return null
    };
    var jg = function (a) {
    ...
    var S = function (a, b, c) {
            ...
            this.m = a;
            a = b || {};
            this.Ne = a.secureTokenEndpoint || "https://securetoken.googleapis.com/v1/token";
            this.Oe = a.secureTokenTimeout || 1E4;
            this.Dd = Wa(a.secureTokenHeaders || kg);
            this.ie = a.firebaseEndpoint || "https://www.googleapis.com/identitytoolkit/v3/relyingparty/";
            this.je = a.firebaseTimeout ||
                1E4;
            this.kd = Wa(a.firebaseHeaders || lg);
        ...
        og = function (a, b, c, d, e, f, g) {
            pf() ? a = q(a.Qe, a) : (mg || (mg = new H(function (a, b) {
                ng(a, b)
            })), a = q(a.Pe, a));
            a(b, c, d, e, f, g)
        };
    S.prototype.Qe = function (a, b, c, d, e, f) {
        var g = "Node" == uf(),
            k = vf() ? g ? new L(this.af) : new L : new L(this.$d),
            t;
        ...
        k.listen("complete", function () {
            ...
            try {
                var c;
                c = this.b ? jc(this.b.responseText) : void 0;
                a = c || null
            } catch (Xi) {
                try {
                    a = JSON.parse(Pe(this)) || null
                } catch (Yi) {
                    a = null
                }
            }
    ...
    S.prototype.Pe = function (a, b, c, d, e) {
        var f = this;
        mg.then(function () {
    ...
    var qg = function (a, b) {
            return new H(function (c, d) {
                "refresh_token" == b.grant_type && b.refresh_token || "authorization_code" == b.grant_type && b.code ? og(a, a.Ne + "?key=" + encodeURIComponent(a.m), function (a) {
                    a ? a.error ? d(pg(a)) : a.access_token && a.refresh_token ? c(a) : d(new Q("internal-error")) : d(new Q("network-request-failed"))
                }, "POST", jf(b).toString(), a.Dd, a.Oe) : d(new Q("internal-error"))
            })
        },
        rg = function (a, b, c, d, e) {
            ...
            return new H(function (b, e) {
                og(a,
                    f,
                    function (a) {
                        a ? a.error ? e(pg(a)) : b(a) : e(new Q("network-request-failed"))
                    }, c, mc(Cf(d)), a.kd, a.je)
            })
        },
        sg = function (a) {
            if (!Zb.test(a.email)) throw new Q("invalid-email");
        },
        tg = function (a) {
            "email" in a && sg(a)
        },
        vg = function (a, b) {
            var c = zf() ? mf() : "http://localhost";
            return R(a, ug, {
                identifier: b,
                continueUri: c
            }).then(function (a) {
    ...
    var Ng = {
        ...
        Mg = {
            ...
            I: Kg,
            wa: function (a) {
                if (!Zb.test(a.email)) throw new Q("internal-error");
            }
        },
        Og = {
        ...
        R =
        function (a, b, c) {
            if (!Kf(c, b.eb)) return J(new Q("internal-error"));
            var d = b.ue || "POST",
                e;
            return I(c).then(b.I).then(function () {
                b.xa && (c.returnSecureToken = !0);
                return rg(a, b.endpoint, d, c, b.Zd || !1)
            }).then(function (a) {
                return e = a
    ...
    var Wg = function (a) {
            ...
            b.U.url = a.$e;
            b.U.messageHandlersFilter = xf("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER");
            b.U.attributes = b.U.attributes || {};
            (new Sg(b.U.attributes)).Gd({
                position: "absolute",
                top: "-100px",
                width: "1px",
                height: "1px"
        ...
        Ug = function (a) {
            return Xg().then(function () {
                return new H(function (b, c) {
                    xf("gapi.iframes.getContext")().open(Wg(a).value(), function (d) {
                        a.Cc = d;
                        a.Cc.restyle({
                            setHideOnLeave: !1
                        });
        ...
        Yg = function (a, b) {
            a.vd.then(function () {
                a.Cc.register("authEvent", b, xf("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"))
            })
        },
        Zg = "__iframefcb" + Math.floor(1E6 * Math.random()).toString(),
        Xg = function () {
            return new H(function (a, b) {
                var c = function () {
                    Ff();
                    xf("gapi.load")("gapi.iframes", {
                        callback: a,
                        ontimeout: function () {
                            Ff();
                ...
                xf("gapi.iframes.Iframe") ? a() : xf("gapi.load") ? c() :
                    (l[Zg] = function () {
                        xf("gapi.load") ? c() : b(Error("Network Error"))
                    }, I(Qd("https://apis.google.com/js/api.js?onload=" + Zg)).l(function () {
                        b(Error("Network Error"))
                    }))
            })
        };
    var $g = function (a, b, c) {
        ...
        this.F = c;
        this.La = null;
        this.u = ef(this.C, "/__/auth/iframe");
        O(this.u, "apiKey", this.m);
        O(this.u, "appName", this.F)
    };
    ...
    $g.prototype.toString = function () {
        this.La ? O(this.u, "v", this.La) : cf(this.u, "v");
    ...
    var ah = function (a, b, c, d, e) {
        ...
        this.$b = e;
        this.u = ef(this.C, "/__/auth/handler");
        O(this.u, "apiKey", this.m);
        O(this.u, "appName", this.F);
        O(this.u, "authType", this.Yd)
    };
    ...
    ah.prototype.toString = function () {
        if (this.$b.isOAuthProvider) {
            O(this.u, "providerId", this.$b.providerId);
            var a = this.$b.ne();
            a && a.length && O(this.u, "scopes", a.join(","));
            a = this.$b.me();
            Ua(a) || O(this.u, "customParameters", Bf(a))
        }
        this.Pc ? O(this.u, "redirectUrl", this.Pc) : cf(this.u, "redirectUrl");
        this.W ? O(this.u, "eventId", this.W) : cf(this.u, "eventId");
        this.La ? O(this.u, "v", this.La) : cf(this.u, "v");
        return this.u.toString()
    };
    var ch = function (a, b, c, d) {
        ...
        this.F = c;
        d = this.Aa = d || null;
        this.ve = (new $g(a, b, c)).setVersion(d).toString();
        this.pd = new Vg(this.ve);
        this.Db = [];
        bh(this)
    };
    ...
    var dh = function (a, b, c, d, e, f, g, k) {
            a = new ah(a, b, c, d, e);
            a.Pc = f;
            a.W = g;
    ...
    h = fh.prototype;
    h.get = function (a) {
        return I(this.w.getItem(a)).then(function (a) {
            return a && Df(a)
        })
    };
    h.set = function (a, b) {
        return I(this.w.setItem(a, Bf(b)))
    };
    h.remove = function (a) {
        return I(this.w.removeItem(a))
    };
    h.Na = function () {};
    h.bb = function () {};
    var gh = function () {
    ...
    var ih = function () {
            if (!hh()) {
                if ("Node" == uf()) throw new Q("internal-error", "The LocalStorage compatibility library was not found.");
    ...
    var lh = function () {
            if (!kh()) {
                if ("Node" == uf()) throw new Q("internal-error", "The SessionStorage compatibility library was not found.");
                throw new Q("web-storage-unsupported");
            }
    ...
    h.set = function (a, b) {
        var c = !1,
            d, e = this;
        return zd(ph(this).then(function (b) {
            d = b;
            b = qh(e, rh(e, d, !0));
            return sh(b.get(a))
        }).then(function (f) {
            var g = qh(e, rh(e, d, !0));
            if (f) return f.value = b, sh(g.put(f));
            e.vb++;
            c = !0;
            f = {};
            f[e.wc] = a;
    ...
    h.get = function (a) {
        var b = this;
        return ph(this).then(function (c) {
            return sh(qh(b, rh(b, c, !1)).get(a))
        }).then(function (a) {
            return a && a.value
        })
    };
    h.remove = function (a) {
        var b = !1,
            c = this;
        return zd(ph(this).then(function (d) {
            b = !0;
            c.vb++;
            return sh(qh(c, rh(c, d, !0))["delete"](a))
        }).then(function () {
            delete c.S[a]
        }), function () {
            b && c.vb--
    ...
    h.Se = function () {
        var a = this;
        return ph(this).then(function (b) {
            var c = qh(a, rh(a, b, !1));
            return c.getAll ? sh(c.getAll()) : new H(function (a, b) {
                var d = [],
                    e = c.openCursor();
    ...
    h.Uc = function () {
        ...
        this.jc();
        var b = function () {
            a.Lc = ze(800).then(q(a.Se, a)).then(function (b) {
                0 < b.length && x(a.zb, function (a) {
                    a(b)
                })
            }).then(b).l(function (a) {
        ...
        Eh = function (a, b, c) {
            ...
            a = function () {
                ...
                a: {
                    ...
                    var k;k = 0;
                    for (var t = !1, ua = 0; ua < c.length; ua++)
                        if (c[ua].optional) t = !0;
                        else {
                    ...
                    if (e.length < k || t < e.length) e = "Expected " + (k ==
                        ...
                        for (k = 0; k < e.length; k++)
                            if (t = c[k].optional && void 0 === e[k], !c[k].ga(e[k]) && !t) {
                                e = c[k];
                                if (0 > k || k >= yh.length) throw new Q("internal-error", "Argument validator received an unsupported number of arguments.");
    ...
    var Hh = function (a, b, c, d) {
            ...
            try {
                var e;
                lf() ? (nh || (nh = new mh("firebaseLocalStorageDb", "firebaseLocalStorage", "fbase_key", "value", 1)), e = nh) : e = new a.gd.Z;
                this.Wa = e
            } catch (f) {
                this.Wa = new gh, this.hb = !0
            }
            try {
                this.lc = new a.gd.Wc
            } catch (f) {
        ...
        Ih, Jh = function () {
            Ih || (Ih = new Hh("firebase", ":", !Ef(kf()) && l.window && l.window != l.window.top ? !0 : !1, Af()));
            return Ih
        };
    h = Hh.prototype;
    h.O = function (a, b) {
        return this.Ge + this.Ed + a.name + (b ? this.Ed + b : "")
    };
    h.get = function (a, b) {
    ...
    h.removeListener = function (a, b, c) {
        a = this.O(a, b);
        this.R[a] && (Ma(this.R[a], function (a) {
            return a == c
    ...
    Hh.prototype.jc = function () {
        this.Wa.bb(this.Hd);
        this.hb || Lh(this)
    };
    Hh.prototype.Id = function (a) {
        if (a && a.le) {
            var b = a.ob.key;
            if (this.Me) {
                var c = l.localStorage.getItem(b);
            ...
            this.ad(b)
        } else x(a, q(this.ad, this))
    };
    Hh.prototype.ad = function (a) {
        this.R[a] && x(this.R[a], function (a) {
            a()
        })
    };
    var Mh = function (a) {
        ...
        Oh = function (a) {
            return a.B.set(Nh, "pending", a.D)
        },
        Ph = function (a) {
            return a.B.remove(Nh, a.D)
        },
        Qh = function (a) {
            return a.B.get(Nh, a.D).then(function (a) {
                return "pending" == a
            })
        };
    var Th = function (a, b, c) {
        var d = this,
            e = (this.Aa = firebase.SDK_VERSION || null) ? wf(this.Aa) : null;
    ...
    Th.prototype.reset = function () {
        ...
        this.Sb = !1;
        this.dc = this.fb = null;
        this.Pb && eh(this.Pb, this.Xc);
        this.Xb = new H(function (b, c) {
            a.fb = b;
            a.dc = c
        })
    };
    var Uh = function (a) {
            var b = mf();
            return xg(a).then(function (a) {
                a: {
                    for (var c = df(b).ia, e = 0; e < a.length; e++) {
                        var f;
                        var g = a[e];
                        f = c;
                        var k = Oc(g);
                        k ? f = (f = Oc(f)) ? k.Ib(f) : !1 : (k = g.split(".").join("\\."), f = (new RegExp("^(.+\\." + k + "|" + k + ")$", "i")).test(f));
                        if (f) {
                            a = !0;
                            break a
                        }
                ...
                if (!a) throw new Rf(mf());
            })
        },
        Vh = function (a) {
            a.Sb || (a.Sb = !0, tf().then(function () {
                a.Pb = new ch(a.C, a.m, a.F, a.Aa);
                a.Pb.Hc().l(function () {
    ...
    Th.prototype.subscribe = function (a) {
        Ja(this.Ab, a) || this.Ab.push(a);
        if (!this.Sb) {
            var b = this,
                c = function () {
                    var a = kf();
                    Af(a) || Ef(a) ? Wh(b.Za) : Vh(b)
                };
            Qh(this.Kc).then(function (a) {
                a ? Ph(b.Kc).then(function () {
                    Vh(b)
                }) : c()
            }).l(function () {
                c()
    ...
    Th.prototype.unsubscribe = function (a) {
        Ma(this.Ab, function (b) {
            return b == a
        })
    };
    Th.prototype.oe = function (a) {
    ...
    Th.prototype.getRedirectResult = function () {
    ...
    var Yh = function (a, b, c, d, e, f) {
            ...
            return a.sa.then(function () {
                ...
                Xh(d);
                var f = dh(a.C, a.m, a.F, c, d, null, e, a.Aa);
                (b || l.window).location.href = ec(hc(f))
            }).l(function (b) {
        ...
        Zh = function (a, b, c, d) {
            ...
            return a.sa.then(function () {
                Xh(c);
                var e = dh(a.C, a.m, a.F, b, c, mf(), d, a.Aa);
                Oh(a.Kc).then(function () {
                    l.window.location.href = ec(hc(e))
                })
            })
        },
        $h = function (a, b, c, d, e) {
            var f = new Q("popup-closed-by-user");
            return a.Xb.l(function () {}).then(function () {
                return sf(d)
            }).then(function () {
                return ze(2E3).then(function () {
                    b.Ja(c, null, f, e)
                })
            })
        },
    ...
    Rh.prototype.zd = function (a, b) {
        if (!a) return J(new Q("invalid-auth-event"));
        this.Oc = !0;
        var c = a.ya,
            d = a.W;
        "unknown" == c ? (this.aa || ci(this, !1, null, null), a = I()) : a = a.N ? this.Mc(a, b) : b.pb(c, d) ? this.Nc(a, b) : J(new Q("invalid-auth-event"));
        return a
    };
    var Wh = function (a) {
        a.Oc || (a.Oc = !0, ci(a, !1, null, null))
    };
    Rh.prototype.Mc = function (a) {
        this.aa || ci(this, !0, null, a.getError());
        return I()
    };
    Rh.prototype.Nc = function (a, b) {
        var c = this,
            d = a.ya;
        b = b.pb(d, a.W);
        var e = a.kb;
    ...
    Rh.prototype.getRedirectResult = function () {
        var a = this;
        this.$c || (this.$c = new H(function (b, c) {
            a.aa ? a.aa().then(b, c) : (a.$a = b, a.cc = c, di(a))
        }));
        return this.$c
    };
    var di = function (a) {
    ...
    Sh.prototype.zd = function (a, b) {
        if (!a) return J(new Q("invalid-auth-event"));
        var c = a.ya,
            d = a.W;
        return a.N ? this.Mc(a, b) : b.pb(c, d) ? this.Nc(a, b) : J(new Q("invalid-auth-event"))
    };
    Sh.prototype.Mc = function (a, b) {
        b.Ja(a.ya, null, a.getError(), a.W);
        return I()
    };
    Sh.prototype.Nc = function (a, b) {
        var c = a.W,
            d = a.ya;
    ...
    var gi = function (a, b) {
        ...
        hi = function (a, b) {
            return qg(a.f, b).then(function (b) {
                a.za = b.access_token;
                a.Sa = fi(b.expires_in);
                a.V = b.refresh_token;
                return {
                    accessToken: a.za,
                    expirationTime: a.Sa,
    ...
    ei.prototype.getToken = function (a) {
        a = !!a;
        return ii(this) ? J(new Q("user-token-expired")) : a || !this.za || la() > this.Sa - 3E4 ? this.V ? hi(this, {
    ...
    var W = function (a, b, c) {
        ...
        a = firebase.SDK_VERSION ? wf(firebase.SDK_VERSION) : null;
        this.f = new S(this.m, null, a);
        this.ea = new ei(this.f);
        li(this, b.idToken);
        gi(this.ea, b);
        ...
        be.call(this);
        this.Yb = !1;
        this.C && zf() && (this.o = bi(this.C, this.m, this.F));
        this.ic = [];
        this.sc = I()
    };
    r(W, be);
    ...
    var wi = function (a) {
        return a.getToken().then(function (b) {
            ...
            return xi(a, b).then(function () {
                ...
                "auth/user-token-expired" == b.code && (a.dispatchEvent(new ki("userDeleted")), yi(a));
                throw b;
            })
        })
    };
    W.prototype.getToken = function (a) {
        ...
        return ri(this).then(function () {
            ...
            a.accessToken != b.rd && (li(b, a.accessToken), b.Fa());
            vi(b, "refreshToken", a.refreshToken);
            return a.accessToken
        }).l(function (a) {
            if ("auth/user-token-expired" == a.code && !c) return oi(b).then(function () {
                vi(b, "refreshToken", null);
                throw a;
            });
            throw a;
        })
    ...
    var zi = function (a, b) {
        b.idToken && a.rd != b.idToken && (gi(a.ea, b), a.Fa(), li(a, b.idToken), vi(a, "refreshToken", a.ea.V))
    };
    W.prototype.Fa = function () {
        this.dispatchEvent(new ki("tokenChanged"))
    };
    var xi = function (a, b) {
        return R(a.f, Qg, {
            idToken: b
    ...
    W.prototype.Je = function (a) {
        ...
        for (var b = Ai(a), c = 0; c < b.length; c++) ui(this, b[c]);
    ...
    var Ai = function (a) {
        return (a = a.providerUserInfo) && a.length ? Fa(a, function (a) {
            return new ji(a.rawId, a.providerId, a.email, a.displayName, a.photoUrl)
        }) : []
    };
    W.prototype.reauthenticate = function (a) {
        ...
        return this.c(a.Kb(this.f).then(function (a) {
            ...
            if (!c || b.uid != c.De) throw new Q("user-mismatch");
            zi(b, a);
            return b.reload()
        }))
    };
    var Bi = function (a, b) {
        return wi(a).then(function () {
            if (Ja(si(a), b)) return oi(a).then(function () {
    ...
    h.Be = function (a) {
        var b = this;
        return this.c(Bi(this, a.provider).then(function () {
            return b.getToken()
        }).then(function (c) {
            return a.td(b.f, c)
        }).then(q(this.jd, this)))
    ...
    h.We = function (a) {
        ...
        return this.c(wi(this).then(function (c) {
            return Ja(si(b), a) ? Fg(b.f, c, [a]).then(function (a) {
                var c = {};
    ...
    h.ce = function () {
        ...
        return this.c(this.getToken().then(function (b) {
            ...
            a.dispatchEvent(new ki("userDeleted"))
        })).then(function () {
            yi(a)
        })
    };
    ...
    var Di = function (a, b) {
        if (!zf()) return J(new Q("operation-not-supported-in-this-environment"));
        var c = Nf(b.providerId),
            d = a.Jb(),
            e = null;
        !Af() && a.C && b.isOAuthProvider && (e = dh(a.C, a.m, a.F, "linkViaPopup", b, null, d, firebase.SDK_VERSION || null));
        var f = rf(e, c && c.xb, c && c.wb),
            c = Bi(a, b.providerId).then(function () {
                return oi(a)
            }).then(function () {
                Ci(a);
                return a.getToken()
            }).then(function () {
                return Yh(a.o, f, "linkViaPopup", b, d, !!e)
            }).then(function () {
                return new H(function (b, c) {
    ...
    W.prototype.Ce = function (a) {
        ...
        var b = this,
            c = null,
            d = this.Jb(),
            e = Bi(this, a.providerId).then(function () {
                Ci(b);
                return b.getToken()
            }).then(function () {
                b.bc = d;
                ...
                b.Ia && (a = b.Ia, a = a.B.set(Ei, b.K(), a.D));
                return a
            }).then(function () {
                return Zh(b.o, "linkViaRedirect", a, d)
            }).l(function (a) {
                c = a;
                if (b.Ia) return Fi(b.Ia);
                throw c;
            }).then(function () {
                if (c) throw c;
            });
    ...
    var Ii = function (a) {
        ...
        Fi = function (a) {
            return a.B.remove(Ei, a.D)
        },
        Ji = function (a, b) {
            return a.B.get(Ei, a.D).then(function (a) {
                a && b && (a.authDomain = b);
                return Gi(a || {})
            })
        };
    var Ki = function (a) {
        ...
        Mi = function (a, b) {
            return a.B.set(Li, b.K(), a.D)
        },
        Ni = function (a) {
            return a.B.remove(Li, a.D)
        },
        Oi = function (a, b) {
            return a.B.get(Li, a.D).then(function (a) {
                a && b && (a.authDomain = b);
                return Gi(a || {})
            })
        };
    var Y = function (a) {
        this.Qa = !1;
        P(this, "app", a);
        if (X(this).options && X(this).options.apiKey) a = firebase.SDK_VERSION ? wf(firebase.SDK_VERSION) : null, this.f = new S(X(this).options && X(this).options.apiKey, null, a);
        else throw new Q("invalid-api-key");
        this.Y = [];
        this.Oa = [];
        this.He = firebase.INTERNAL.createSubscribe(q(this.xe, this));
        Pi(this, null);
        this.oa = new Ki(X(this).options.apiKey + ":" + X(this).name);
        this.ab = new Ii(X(this).options.apiKey + ":" + X(this).name);
        this.Eb = this.c(Qi(this));
        this.va = this.c(Ri(this));
        this.Ec = !1;
        this.Bc = q(this.Re, this);
    ...
    var Ti = function (a) {
            return a.ee || J(new Q("auth-domain-config-required"))
        },
        Si = function (a) {
            var b = X(a).options.authDomain,
                c = X(a).options.apiKey;
            b && zf() && (a.ee = a.Eb.then(function () {
                if (!a.Qa) return a.o = bi(b, c, X(a).name), a.o.subscribe(a), Z(a) && pi(Z(a)), a.Qc && (pi(a.Qc), a.Qc = null), a.o
            }))
        };
    h = Y.prototype;
    h.bd = function (a, b) {
    ...
    h.signInWithPopup = function (a) {
        ...
        var b = this,
            ...
            d = this.Jb(),
            e = null;
        !Af() && X(this).options.authDomain && a.isOAuthProvider && (e = dh(X(this).options.authDomain, X(this).options.apiKey, X(this).name, "signInViaPopup", a, null, d, firebase.SDK_VERSION || null));
        var f = rf(e, c && c.xb, c && c.wb),
            c = Ti(this).then(function (b) {
                return Yh(b, f, "signInViaPopup", a, d, !!e)
            }).then(function () {
                return new H(function (a, c) {
                    ...
                    b.Ha = c;
                    b.ka = d;
                    b.G = $h(b.o, b, "signInViaPopup", f, d)
                })
            }).then(function (a) {
                f && qf(f);
                return a
    ...
    h.signInWithRedirect = function (a) {
        if (!zf()) return J(new Q("operation-not-supported-in-this-environment"));
        var b = this,
            c = Ti(this).then(function () {
                return Zh(b.o, "signInViaRedirect", a)
            });
        return this.c(c)
    };
    ...
    var Ui = function (a, b) {
        ...
        Pi = function (a, b) {
            Z(a) && (ni(Z(a), a.Kd), Ub(Z(a), "tokenChanged", a.Ld), Ub(Z(a), "userDeleted", a.Jd));
            b && (b.ic.push(a.Kd), Lb(b, "tokenChanged", a.Ld), Lb(b, "userDeleted", a.Jd));
            P(a, "currentUser", b)
        };
    ...
    var Vi = function (a) {
            var b = Ji(a.ab, X(a).options.authDomain).then(function (b) {
                if (a.Qc = b) b.Ia = a.ab;
                return Fi(a.ab)
            });
            return a.c(b)
        ...
        Qi = function (a) {
            var b = X(a).options.authDomain,
                c = Vi(a).then(function () {
                    return Oi(a.oa, b)
                }).then(function (b) {
                    return b ? (b.Ia = a.ab, b.reload().then(function () {
                        return Mi(a.oa, b).then(function () {
                            return b
                        })
                    }).l(function (c) {
                        return "auth/network-request-failed" == c.code ? b : Ni(a.oa)
                    })) : null
                }).then(function (b) {
                    Pi(a, b || null)
                });
        ...
        Ri = function (a) {
            return a.Eb.then(function () {
                ...
                if (!a.Qa) {
                    a.Ec = !0;
                    var b = a.oa;
                    b.B.addListener(Li, b.D, a.Bc)
                }
            })
        };
    Y.prototype.Re = function () {
        var a = this;
        return Oi(this.oa, X(this).options.authDomain).then(function (b) {
            if (!a.Qa) {
                var c;
                if (c = Z(a) && b) {
                    c = Z(a).uid;
                ...
                if (Z(a) || b) Pi(a, b), b && (pi(b), b.Ia = a.ab), a.o && a.o.subscribe(a), a.Fa()
            }
        })
    };
    ...
    h.signInWithCredential = function (a) {
        var b = this;
        return this.va.then(function () {
            return Wi(b, a.Kb(b.f))
        })
    };
    h.signInAnonymously = function () {
        var a = Z(this),
            b = this;
        return a && a.isAnonymous ? I(a) : this.va.then(function () {
            return Wi(b, b.f.signInAnonymously())
        }).then(function (a) {
            vi(a, "isAnonymous", !0);
            return b.Ua(a)
        }).then(function () {
    ...
    h.addAuthTokenListener = function (a) {
        ...
        this.c(this.va.then(function () {
            b.Qa || Ja(b.Oa, a) && a(Z(b) && Z(b)._lat || null)
        }))
    };
    h.removeAuthTokenListener = function (a) {
        Ma(this.Oa, function (b) {
            return b == a
        })
    };
    h.delete = function () {
        ...
        this.Y = [];
        this.oa && (a = this.oa, a.B.removeListener(Li, a.D, this.Bc));
    ...
    V(Yf, "credential", Yf.credential, [Dh(T(), U(), "token")]);
    Fh(Zf.prototype, {
        addScope: {
            name: "addScope",
            a: [T("scope")]
    ...
    V(Zf, "credential", Zf.credential, [Dh(T(), U(), "token")]);
    Fh($f.prototype, {
        addScope: {
            name: "addScope",
            a: [T("scope")]
    ...
    V($f, "credential", $f.credential, [Dh(T(), Dh(U(), Ah()), "idToken"), Dh(T(), Ah(), "accessToken", !0)]);
    Fh(ag.prototype, {
        setCustomParameters: {
            name: "setCustomParameters",
            a: [U("customOAuthParameters")]
...
(function () {
    ...
    Dd.prototype.open = function (a, b) {
        ...
        this.La.onmessage = function (a) {
            if (null !== e.La)
                if (a = a.data, e.qb +=
                    a.length, kc(e.Xa, "bytes_received", a.length), Fd(e), null !== e.frames) Gd(e, a);
                else {
                    a: {
    ...
    Pd.prototype.gb = function (a, b, c, d) {
        var e = new Id,
            f;
        if (b.type === ac) b.source.ee ? c = Qd(this, a, b.path, b.Ja, c, d, e) : (H(b.source.We, "Unknown source."), f = b.source.Ee || Ec(a.w()) && !b.path.e(), c = Rd(this, a, b.path, b.Ja, c, d, f, e));
        else if (b.type === wd) b.source.ee ? c = Sd(this, a, b.path, b.children, c, d, e) : (H(b.source.We, "Unknown source."), f = b.source.Ee || Ec(a.w()), c = Td(this, a, b.path, b.children, c, d, f, e));
        else if (b.type === Ud)
            if (b.Id)
                if (b = b.path, null != c.mc(b)) c = a;
                    ...
                    if (b.e() || ".priority" === J(b)) Dc(a.w()) ?
                        b = c.Ba(Ac(a)) : (b = a.w().j(), H(b instanceof P, "serverChildren would be complete if leaf node"), b = c.sc(b)), b = this.V.za(d, b, e);
                    else {
                        var h = J(b),
                            k = c.rc(h, a.w());
        ...
        else c = Wd(this, a, b.path, b.Pb, c, d, e);
        else if (b.type === cc) d = b.path, b = a.w(), f = b.j(), h = b.ea || d.e(), c = Xd(this, new Yd(a.O, new zc(f,
            h, b.Tb)), d, c, wc, e);
    ...
    function Xd(a, b, c, d, e, f) {
        ...
        var k;
        if (c.e()) H(Dc(b.w()), "If change path is empty, we must have complete server data"), Ec(b.w()) ? (e = Ac(b), d = d.sc(e instanceof P ? e : F)) : d = d.Ba(Ac(b)), f = a.V.za(b.O.j(), d, f);
        else {
            var m = J(c);
            if (".priority" == m) H(1 == $d(c), "Can't have a priority with additional path components"), f = h.j(), k = b.w().j(), d = d.$c(c, f, k), f = null != d ? a.V.ga(f, d) : h.j();
            else {
                var l = D(c);
    ...
    function Qd(a, b, c, d, e, f, h) {
        var k = b.O;
        e = new xc(e, b, f);
        if (c.e()) h = a.V.za(b.O.j(), d, h), a = Vd(b, h, !0, a.V.Qa());
        else if (f = J(c), ".priority" === f) h = a.V.ga(b.O.j(), d), a = Vd(b, h, k.ea, k.Tb);
        else {
            c = D(c);
            var m = k.j().R(f);
            if (!c.e()) {
    ...
    g.hash = function () {
        if (null === this.Eb) {
            ...
            var b = typeof this.B,
                a = a + (b + ":"),
                a = "number" === b ? a + id(this.B) : a + this.B;
            this.Eb = Uc(a)
        }
        return this.Eb
    };
    ...
    function df(a, b) {
        return function (c) {
            if (2 != a.L)
                ...
                if (d = ed("t", c), c = ed("d", c), "c" == d) "t" in c && (c = c.t, "a" === c ? mf(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.D.close(), a.Xc !== a.D && a.Rc !== a.D || a.close()) : "o" === c && (a.f("got pong on secondary."),
                    a.xf--, mf(a)));
    ...
    function mf(a) {
        ...
        }), a.Xc = a.D, hf(a)) : (a.f("sending ping on secondary."), a.D.send({
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function lf(a) {
        a.Cb || 1 !== a.L || (a.f("sending ping on primary."), nf(a, {
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function Ff(a, b, c) {
        ...
        if (ha(b)) {
            ...
            Cb(b, function (b, h) {
                if (".value" === b) d = !0;
                else if (".priority" !== b && ".sv" !== b && (e = !0, !Cf(b))) throw Error(a + " contains an invalid key (" + b + ") " + rf(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                c.push(b);
                Ff(a, h, c);
                c.pop()
            });
    ...
    function Gf(a, b) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            for (var e = d.slice(), f = 0; f < e.length; f++)
                if ((".priority" !== e[f] || f !== e.length - 1) && !Cf(e[f])) throw Error(a + "contains an invalid key (" + e[f] + ") in path " + d.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
        }
        b.sort( of );
        e = null;
        for (c = 0; c < b.length; c++) {
    ...
    g.remove = function (a, b) {
        var c, d;
        c = this;
        if (0 > b(a, c.key)) c.left.e() || c.left.fa() || c.left.left.fa() || (c = dg(c)), c = c.Y(null, null, null, c.left.remove(a, b), null);
        else {
            c.left.fa() && (c = eg(c));
    ...
    function og(a, b) {
        ...
        var c = a.n,
            d = new fe(c.g),
            c = S(c) ? new fe(c.g) : c.ya ? new le(c) : new ge(c);
        this.of = new Pd(c);
        var e = b.w(),
            f = b.O,
            h = d.za(F, e.j(), null),
    ...
    g.hc = function (a, b, c, d) {
        ...
        if ("value" === a) yg(this.u, this, new sg(b, e.cancel || null, e.Pa || null));
        else {
            var f = {};
            f[a] = b;
    ...
    g.kg = function (a, b) {
        ...
        Jf("Query.once", a, !1);
        A("Query.once", 2, b, !0);
        var d = xg("Query.once", arguments[2], arguments[3]),
            e = this,
            f = !0,
            h = new Hb;
        Jb(h.sa);
    ...
    g.Ed = function (a) {
        ...
        if (d) {
            if (e) this.T = eh(this.ma, fh, C), this.Cc = 0 < this.ma.length ? this.ma[this.ma.length - 1].Zc : -1;
    ...
    function eh(a, b, c) {
        for (var d = Rg, e = 0; e < a.length; ++e) {
            ...
            if (b(f)) {
                var h = f.path;
                if (f.Ja) c.contains(h) ? (h = T(c, h), d = Sg(d, h, f.Ja)) : h.contains(c) && (h = T(h, c), d = Sg(d, C, f.Ja.Q(h)));
                else if (f.children)
                    if (c.contains(h)) h = T(c, h), d = Tg(d, h, f.children);
                    else {
                        if (h.contains(c))
                            if (h = T(h, c), h.e()) d = Tg(d, C, f.children);
                            else if (f = x(f.children, J(h))) f = f.Q(D(h)), d = Sg(d, C, f)
                    }
    ...
    function oh(a, b, c, d, e, f) {
        ...
        qh(this, 0);
        Tf.Wb().hc("visible", this.jg, this); - 1 ===
    ...
    g.re = function (a, b, c) {
        this.na ? wh(this, "o", a, b, c) : this.Lc.push({
            we: a,
            action: "o",
            data: b,
            G: c
    ...
    g.gf = function (a, b, c) {
        this.na ? wh(this, "om", a, b, c) : this.Lc.push({
            we: a,
            action: "om",
            data: b,
            G: c
    ...
    g.xd = function (a, b) {
        this.na ? wh(this, "oc", a, null, b) : this.Lc.push({
            we: a,
            action: "oc",
            data: null,
            G: b
    ...
    function tf(a, b, c) {
        ...
        this.vd = 1;
        this.Ua = null;
        if (b || 0 <= ("object" === typeof window && window.navigator && window.navigator.userAgent || "").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)) this.wa = new pd(this.M, r(this.Hb, this), d), setTimeout(r(this.Kc, this, !0), 0);
        else {
    ...
    g.update = function (a, b, c) {
        ...
        if (d) E("update() called with empty data.  Don't do anything."), ci(c, "ok");
        else {
            var h = this.vd++,
                k = Gh(this.K, a, f, h);
            nc(this.da, k);
    ...
    function ki(a, b, c) {
        if (0 !== b.length) {
            for (var d = [], e = [], f = Ka(b, function (a) {
                ...
                if (5 === k.status) l = !0, u = k.Td, e = e.concat(Hh(a.K, k.Da, !0));
                else if (1 === k.status)
                    if (25 <= k.wf) l = !0, u = "maxretry", e = e.concat(Hh(a.K, k.Da, !0));
                    else {
    ...
    function mi(a, b) {
        var c = b.Ea();
        if (null !== c) {
            for (var d = [], e = [], f = -1, h = 0; h < c.length; h++) 4 !== c[h].status && (2 === c[h].status ? (H(f === h - 1, "All SENT items should be at beginning of queue."), f = h, c[h].status = 4, c[h].Td = "set") : (H(1 === c[h].status, "Unexpected transaction status in abort"), c[h].Rd(), e = e.concat(Hh(a.K, c[h].Da, !0)), c[h].G && d.push(r(c[h].G, null, Error("set"), !1, null)))); - 1 === f ? kh(b, null) : c.length = f + 1;
            rc(a.da, b.path(), e);
            for (h = 0; h < d.length; h++) Ub(d[h])
        }
    };
    ...
    var yc = function (a, b, c) {
            if (0 == a.a) {
                ...
                a: {
                    ...
                    Kc(e, Cc(f || ba, g || null, a)),
                    d = !0;
                    else if (Ia(e)) e.then(f, g, a),
                    d = !0;
                    else {
                        if (ea(e)) try {
                            var h = e.then;
